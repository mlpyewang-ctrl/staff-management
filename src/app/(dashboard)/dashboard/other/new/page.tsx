...
export default function OtherNewPage() {
  ...
  const submit = async (action: 'save' | 'submit', event: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">新建其他事项申请</h1>
        ...
        <CardContent>
          <form className="space-y-4" onSubmit={(event) => submit(submitIntentRef.current, event)}>
            ...
            <div className="space-y-2">
              ...
              <Input id="title" name="title" type="text" required placeholder={placeholder.title} />
            </div>

            <div className="space-y-2">
              <Label htmlFor="content">申请内容</Label>
              <Textarea id="content" name="content" rows={10} required placeholder={placeholder.content} />
            </div>
